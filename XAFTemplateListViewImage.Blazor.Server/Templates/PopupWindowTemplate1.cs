...
{
    public class PopupWindowTemplate1 : PopupWindowTemplateBase, ISupportActionsToolbarVisibility, ISupportListEditorInlineActions, ISupportListEditorContextMenuActions, ITemplateToolbarProvider
    {
        public PopupWindowTemplate1() : base()
        {
